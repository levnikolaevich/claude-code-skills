...
**Do NOT use for:**
- Best practices / patterns → use ln-guide-creator
- Architectural decisions → use ln-adr-creator
...
```python
# 1. Copy template
manual_content = read("ln-manual-creator/references/manual_template.md")
...
3. **Return Path**
   ...
   - Used by ln-story-validator or ln-task-executor for inserting links
...
- **ln-guide-creator:** Create best practices guides (patterns, "how to")
- **ln-adr-creator:** Create architecture decision records (decisions, "why")
- **ln-docs-creator:** Create comprehensive project documentation (pre-planning)

---

**Version:** 1.1.0 (Auto-invocation by ln-story-validator)
