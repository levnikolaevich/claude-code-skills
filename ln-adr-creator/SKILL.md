---
name: ln-adr-creator
description: Creates minimal ADRs via 5-question dialog. Categorizes as Strategic (business/patterns) or Technical (frameworks/infra). Nygard format, 7 sections (~300-500 words). Used after ln-docs-creator.
---
...
**Prerequisites:**
- `docs/adrs/` directory must exist (created by ln-docs-creator)

**Do NOT use this skill:**
- When creating initial project documentation → use [ln-docs-creator](../ln-docs-creator/SKILL.md) instead
- When creating full documentation system → use [ln-docs-system](../ln-docs-system/SKILL.md) instead
...
2. Copy template: `ln-adr-creator/references/adr_template.md` → `docs/adrs/adr-{number}-{slug}.md`
...
3. Update [architecture.md](../ln-docs-creator/references/architecture_template_lean.md) Section 9 to reference ADR
...
- Error: "ADR directory not found. Please run ln-docs-creator first."
- Suggest: "Run ln-docs-creator or ln-docs-system to create initial structure"
