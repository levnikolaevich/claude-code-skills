...
- Part of Story Review (Phase 4 Step 3 in ln-story-coordinator)
...
# Deleted by: ln-test-executor Step 6 (after E2E/Integration/Unit tests implemented)
...
**Lifecycle:**
- Created: ln-manual-tester Phase 7
- Used: Re-run after refactoring/fixes
- Deleted: ln-test-executor Step 6 (after automated tests implemented)
...
This skill does NOT:
- Create fix tasks in Linear (ln-story-coordinator creates tasks)
- Change Story or Task statuses (ln-story-coordinator manages statuses)
- Make workflow decisions (ln-story-coordinator decides next step)
- Run automated tests (that's ln-regression-checker or ln-test-executor)
- Create test task (that's ln-test-coordinator)

**Rationale:** Single Responsibility Principle - this skill ONLY performs manual testing and documents results. All workflow logic belongs to ln-story-coordinator orchestrator.
