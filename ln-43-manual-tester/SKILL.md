...
- Part of Story Review (Phase 4 Step 3 in ln-30-story-executor)
...
# Deleted by: ln-34-test-executor Step 6 (after E2E/Integration/Unit tests implemented)
...
**Lifecycle:**
- Created: ln-43-manual-tester Phase 7
- Used: Re-run after refactoring/fixes
- Deleted: ln-34-test-executor Step 6 (after automated tests implemented)
...
- Run automated tests (that's ln-42-regression-checker or ln-34-test-executor)
- Create test task (that's ln-50-story-test-planner)

**Rationale:** Single Responsibility Principle - this skill ONLY performs manual testing and documents results. All workflow logic belongs to ln-30-story-executor orchestrator.
