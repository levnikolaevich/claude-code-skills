---
name: ln-22-adr-creator
description: Creates minimal ADRs via 5-question dialog. Categorizes as Strategic (business/patterns) or Technical (frameworks/infra). Nygard format, 7 sections (~300-500 words). Used after ln-61-docs-creator.
---
...
**Prerequisites:**
- `docs/adrs/` directory must exist (created by ln-61-docs-creator)

**Do NOT use this skill:**
- When creating initial project documentation → use [ln-61-docs-creator](../ln-61-docs-creator/SKILL.md) instead
- When creating full documentation system → use [ln-60-docs-system](../ln-60-docs-system/SKILL.md) instead
...
2. Copy template: `ln-22-adr-creator/references/adr_template.md` → `docs/adrs/adr-{number}-{slug}.md`
...
3. Update [architecture.md](../ln-61-docs-creator/references/architecture_template_lean.md) Section 9 to reference ADR
...
- Error: "ADR directory not found. Please run ln-61-docs-creator first."
- Suggest: "Run ln-61-docs-creator or ln-60-docs-system to create initial structure"
