---
name: ln-docs-updater
description: Updates project docs when code changes. Scans git diff to identify changes, updates affected sections in requirements/architecture/specs/ADRs while preserving existing content. Run ln-html-builder after.
---
...
**Prerequisites**: Existing documentation must be present in `docs/project/` directory (created by ln-docs-creator skill).
...
2. **If HTML Presentation Exists**:
   ...
   - Recommend: "To update HTML presentation with latest changes, run: ln-html-builder"
   - Explain benefit: "ln-html-builder will re-read updated MD files and rebuild presentation_final.html"
...
**Output**: Recommendation to run ln-html-builder (if HTML exists)
...
2. **Recommend ln-html-builder**: If HTML exists, recommend user to run ln-html-builder skill
3. **Explain benefit**: "ln-html-builder will automatically re-read updated MD files and rebuild presentation"
4. **Do NOT edit HTML directly**: ln-html-builder owns HTML templates and build process
...
- [ ] If HTML presentation exists:
  ...
  - Recommendation given: "To update HTML presentation with latest changes, run: ln-html-builder"
  - Benefit explained: "ln-html-builder will re-read updated MD files and rebuild presentation_final.html"
...
- [ ] HTML recommendation status (if applicable): "Run ln-html-builder to update HTML presentation"
- [ ] File locations provided: "Updated files: docs/project/*.md"

**Output:** Updated documentation in `docs/project/` (MD files + ADRs) with change summary + ln-html-builder recommendation (if HTML exists)
...
**Dependencies**:
- Requires existing documentation in `docs/project/` (created by ln-docs-creator skill)
