...
1. **Generate Story Documents:**
   ...
   - Generate complete 8 sections:
     ...
     - Implementation Tasks (placeholder: "Tasks will be created via ln-10-story-decomposer after Story verification")
...
Next Steps:
1. Run ln-20-story-validator to validate Stories before approval
2. Use ln-10-story-decomposer to create tasks for each Story
```
...
2. Run ln-20-story-validator on updated/created Stories
3. Use ln-10-story-decomposer to create/replan tasks
```
...
- **../ln-70-epic-creator/references/linear_integration.md:** Shared discovery patterns and Linear API
...
- **Test Strategy:** Include Risk-Based Testing section - guides final test task creation via ln-50-story-test-planner
