...
<!-- SCOPE: Implementation tasks ONLY. DO NOT create new tests in this task.
     New tests (E2E/Integration/Unit) are created separately by x-test-coordinator after manual testing passes.
...
DO NOT create new tests here. New tests are created by x-test-coordinator after manual testing.
...
- [ ] NO new tests created (new tests are in Story's final test task by x-test-coordinator)
