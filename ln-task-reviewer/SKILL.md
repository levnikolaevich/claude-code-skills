...
2. **Determine task type:**
   - **Test Task:** Has label "tests" OR created by ln-test-coordinator
...
**Reference:** For test tasks, see `ln-test-coordinator/references/test_task_template.md` for 11-section Story Finalizer structure and `ln-test-coordinator/references/risk_based_testing_guide.md` for Risk Priority methodology and test limits.
