...
1. **Generate Story Documents:**
   ...
   - Generate complete 8 sections:
     ...
     - Implementation Tasks (placeholder: "Tasks will be created via ln-task-coordinator after Story verification")
...
Next Steps:
1. Run ln-story-validator to validate Stories before approval
2. Use ln-task-coordinator to create tasks for each Story
```
...
2. Run ln-story-validator on updated/created Stories
3. Use ln-task-coordinator to create/replan tasks
```
...
- **../ln-epic-creator/references/linear_integration.md:** Shared discovery patterns and Linear API
...
- **Test Strategy:** Include Risk-Based Testing section - guides final test task creation via ln-test-coordinator
