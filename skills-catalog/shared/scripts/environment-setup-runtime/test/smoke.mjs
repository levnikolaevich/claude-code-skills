...
try {
    ...
    run(["record-worker", "--project-root", projectRoot, "--identifier", "targets-both", "--payload", JSON.stringify({ schema_version: "1.0", summary_kind: "env-config-sync", run_id: started.run_id, identifier: "targets-both", producer_skill: "ln-013", produced_at: "2026-03-26T00:00:00Z", payload: { status: WORKER_SUMMARY_STATUSES.COMPLETED, targets: ["claude"] } })]);
