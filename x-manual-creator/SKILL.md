...
**Do NOT use for:**
- Best practices / patterns → use x-guide-creator
- Architectural decisions → use x-adr-creator
...
```python
# 1. Copy template
manual_content = read("x-manual-creator/references/manual_template.md")
...
3. **Return Path**
   ...
   - Used by x-story-validator or x-task-executor for inserting links
...
- **x-guide-creator:** Create best practices guides (patterns, "how to")
- **x-adr-creator:** Create architecture decision records (decisions, "why")
- **x-docs-creator:** Create comprehensive project documentation (pre-planning)

---

**Version:** 1.1.0 (Auto-invocation by x-story-validator)
