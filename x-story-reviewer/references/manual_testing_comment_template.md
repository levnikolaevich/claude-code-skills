...
**Decision Criteria:**
- Priority ≥15 → MUST test (x-story-finalizer will create automated tests)
- Priority 9-14 → SHOULD test if not already covered
- Priority ≤8 → SKIP (manual testing sufficient)

**Reference:** See `x-story-finalizer/references/risk_based_testing_guide.md` for complete Business Impact/Probability scoring tables and methodology.
