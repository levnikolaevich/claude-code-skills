...
**Prerequisites**: Existing documentation must be present in `docs/project/` directory (created by x-docs-creator skill).
...
2. **If HTML Presentation Exists**:
   ...
   - Recommend: "To update HTML presentation with latest changes, run: x-html-builder"
   - Explain benefit: "x-html-builder will re-read updated MD files and rebuild presentation_final.html"
...
**Output**: Recommendation to run x-html-builder (if HTML exists)
...
2. **Recommend x-html-builder**: If HTML exists, recommend user to run x-html-builder skill
3. **Explain benefit**: "x-html-builder will automatically re-read updated MD files and rebuild presentation"
4. **Do NOT edit HTML directly**: x-html-builder owns HTML templates and build process
...
- [ ] If HTML presentation exists:
  ...
  - Recommendation given: "To update HTML presentation with latest changes, run: x-html-builder"
  - Benefit explained: "x-html-builder will re-read updated MD files and rebuild presentation_final.html"
...
- [ ] HTML recommendation status (if applicable): "Run x-html-builder to update HTML presentation"
- [ ] File locations provided: "Updated files: docs/project/*.md"

**Output:** Updated documentation in `docs/project/` (MD files + ADRs) with change summary + x-html-builder recommendation (if HTML exists)
