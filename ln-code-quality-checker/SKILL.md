...
- Part of Story Review (Phase 4 Step 1 in ln-story-coordinator - FIRST quality gate)
...
This skill does NOT:
- Create refactoring tasks in Linear (ln-story-coordinator creates tasks)
...
**Rationale:** Single Responsibility Principle - this skill ONLY analyzes code quality and reports issues. All workflow logic belongs to ln-story-coordinator orchestrator.
